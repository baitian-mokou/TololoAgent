...
Generated at: `2026-06-28T09:52:50`
...
| --- | ---: | --- | ---: |
| `python -m unittest discover tests` | 0 | true | 10.946 |
| `python scripts/run_single_source_retrieval_eval.py` | 0 | true | 108.489 |
| `python scripts/run_source_expansion_eval.py --source wikidata` | 0 | true | 1.974 |
| `python scripts/run_source_expansion_eval.py --source nasa` | 0 | true | 1.033 |
| `python scripts/collect_eval_failures.py` | 0 | true | 0.172 |
| `python scripts/smoke_default_source_boundary.py` | 0 | true | 30.588 |
