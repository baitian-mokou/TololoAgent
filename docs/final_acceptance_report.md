...
Generated at: `2026-06-27T22:34:38`
...
| --- | ---: | --- | ---: |
| `python -m unittest discover tests` | 0 | true | 10.056 |
| `python scripts/run_single_source_retrieval_eval.py` | 0 | true | 81.485 |
| `python scripts/run_source_expansion_eval.py --source wikidata` | 0 | true | 1.683 |
| `python scripts/run_source_expansion_eval.py --source nasa` | 0 | true | 0.81 |
| `python scripts/collect_eval_failures.py` | 0 | true | 0.078 |
| `python scripts/smoke_default_source_boundary.py` | 0 | true | 27.895 |
