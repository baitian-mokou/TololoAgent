...
Generated at: `2026-06-27T22:15:24`
...
| --- | ---: | --- | ---: |
| `python -m unittest discover tests` | 0 | true | 11.83 |
| `python scripts/run_single_source_retrieval_eval.py` | 0 | true | 100.609 |
| `python scripts/run_source_expansion_eval.py --source wikidata` | 0 | true | 1.693 |
| `python scripts/run_source_expansion_eval.py --source nasa` | 0 | true | 0.764 |
| `python scripts/collect_eval_failures.py` | 0 | true | 0.078 |
| `python scripts/smoke_default_source_boundary.py` | 0 | true | 34.16 |
