...
Generated at: `2026-07-07T13:29:57`
...
| --- | ---: | --- | ---: |
| `python scripts/run_auto_source_router_eval.py` | 0 | true | 0.359 |
| `python -m unittest discover tests` | 0 | true | 15.809 |
| `python scripts/run_single_source_retrieval_eval.py` | 0 | true | 100.433 |
| `python scripts/run_source_expansion_eval.py --source wikidata` | 0 | true | 3.36 |
| `python scripts/run_source_expansion_eval.py --source nasa` | 0 | true | 1.003 |
| `python scripts/collect_eval_failures.py` | 0 | true | 0.156 |
| `python scripts/smoke_default_source_boundary.py` | 0 | true | 23.365 |
...
| `nasa_source_expansion` | 1 | 16/16 | source_filter=0, metadata=0, inferred=0, explainability=0 |
