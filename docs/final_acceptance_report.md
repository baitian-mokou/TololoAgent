...
Generated at: `2026-06-28T10:32:42`
...
| --- | ---: | --- | ---: |
| `python -m unittest discover tests` | 0 | true | 10.521 |
| `python scripts/run_single_source_retrieval_eval.py` | 0 | true | 89.963 |
| `python scripts/run_source_expansion_eval.py --source wikidata` | 0 | true | 1.66 |
| `python scripts/run_source_expansion_eval.py --source nasa` | 0 | true | 0.758 |
| `python scripts/collect_eval_failures.py` | 0 | true | 0.066 |
| `python scripts/smoke_default_source_boundary.py` | 0 | true | 35.351 |
