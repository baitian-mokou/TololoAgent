...
- source_counts: {'zh_wikipedia': {'total': 3, 'repaired_preview_count': 0, 'rejected_remaining': 3}, 'nasa': {'total': 5, 'repaired_preview_count': 0, 'rejected_remaining': 5}, 'esa': {'total': 7, 'repaired_preview_count': 0, 'rejected_remaining': 7}}
- source_readiness: {'zh_wikipedia': 'blocked_needs_source_strategy_repair', 'nasa': 'blocked_needs_source_strategy_repair', 'esa': 'blocked_needs_source_strategy_repair'}
