...
|---|---|---|---:|---:|---|---|---|
| arxiv_preprint_candidate | manual_sample_first | pending | 5-10 | 0 |  | academic or preprint domain, publication/abstract signal, reference signal present | manual sample 5-10 candidates before ingest |
| data_portal_candidate | ready_for_small_batch | pending | 10-20 | 0 |  | official or academic domain, short text, topic taxonomy hits=4 | manual approve 10-20 samples before ingest |
| journal_publisher_candidate | manual_sample_first | pending | 5-10 | 0 |  | organization domain, publication/abstract signal, short text | manual sample 5-10 candidates before ingest |
| museum_observatory_candidate | manual_sample_first | pending | 5-10 | 0 |  | organization domain, short text, topic taxonomy hits=4 | manual sample 5-10 candidates before ingest |
| noaa_climate_candidate | ready_for_small_batch | pending | 10-20 | 0 |  | official or academic domain, topic taxonomy hits=4, science keyword hits=5 | manual approve 10-20 samples before ingest |
| university_lab_candidate | manual_sample_first | pending | 5-10 | 0 |  | academic or preprint domain, short text, topic taxonomy hits=3 | manual sample 5-10 candidates before ingest |
