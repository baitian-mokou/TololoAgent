...
| generic_unknown_example | needs_manifest_fix | needs_manifest_fix | 0 | 0 |  | news/update signal, topic taxonomy hits=1, very short text | fix manifest before any ingest trial |
| official_science_example | ready_for_small_batch | pending | 10-20 | 0 |  | official or academic domain, science keyword hits=11, fact or overview page signal | manual approve 10-20 samples before ingest |
